...
<head>
    ...
    <title>Update tên nhà sản xuất</title>
...
<body>
    ...
    <?php  
        $errors =[];
        if(isset($_POST['btnUpdatensx'])){
            $httt_ten = $_POST['txt_httt_ten_update_nsx'];
...
EOT;
    ...
    <form name="frmUpdatensx" id="frmUpdatensx" method="post" action="">
        <table>
            <tr>
            ...
            <td>
                <div class="form-group">
                    <input type="text" class="form-control" name="txt_httt_ten_update_nsx" id="txt_httt_ten_update_nsx" aria-describedby="emailHelp">
                </div>
            </td>
            </tr>
            <tr>
                <td>
                    ...
                    -->
                    <?php if (
                    isset($_POST['btnUpdatensx'])  // Nếu người dùng có bấm nút "Lưu dữ liệu"
            ...
            <tr>
            <td>
                <input type="submit" name="btnUpdatensx" id="btnUpdatensx" value="Lưu dữ liệu"/>
            </td>
            </tr>
        </table>
    </form>

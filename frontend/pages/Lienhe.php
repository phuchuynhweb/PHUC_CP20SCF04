    ...
    <main role="main" class="mb-2">
        ...
        if (isset($_POST['btnGoiLoiNhan'])) {
            ...
            try {
                ...
                $mail->Username = 'hhphucd20087@cusc.ctu.edu.vn'; // SMTP username
                $mail->Password = 'memsgigzodksmfgf';                   // SMTP password
                ...
                //Recipients
                $mail->setFrom('hhphucd20087@cusc.ctu.edu.vn', 'Mail Liên hệ');
